# Generated by Django 3.2.3 on 2023-11-24 18:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_to_favorites', models.ManyToManyField(related_name='added_to_favorites', to=settings.AUTH_USER_MODEL)),
                ...
                ('shopping_cart', models.ManyToManyField(related_name='shopping_cart', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
